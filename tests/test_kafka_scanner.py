...
class KafkaScannerTest(BaseScannerTest):
    ...
    def test_kafka_scan(self, client_mock, simple_consumer_mock, num_partitions=1, expected_batches=1):
        expected_messages = 7
    ...
    def test_kafka_scan_partitions(self, client_mock, simple_consumer_mock):
        self.test_kafka_scan(num_partitions=3, expected_batches=1)

    def test_kafka_scan_count(self, client_mock, simple_consumer_mock, num_partitions=1, expected_batches=1):
        expected_messages = 2
        client_mock.return_value = FakeClient(self.samples, num_partitions)
        _, number_of_batches, messages = self._get_scanner_messages(client_mock, simple_consumer_mock,
    ...
    def test_kafka_scan_count_partitions(self, client_mock, simple_consumer_mock):
        self.test_kafka_scan_count(num_partitions=3)

    def test_kafka_scan_batchsize(self, client_mock, simple_consumer_mock, num_partitions=1):
        expected_messages = 7
        expected_batches = 4
        client_mock.return_value = FakeClient(self.samples, num_partitions)
        _, number_of_batches, messages = self._get_scanner_messages(client_mock, simple_consumer_mock,
    ...
    def test_kafka_scan_batchsize_partitions(self, client_mock, simple_consumer_mock):
        self.test_kafka_scan_batchsize(num_partitions=3)

    def test_kafka_scan_batchsize_count(self, client_mock, simple_consumer_mock, num_partitions=1):
        expected_messages = 5
        expected_batches = 3
        client_mock.return_value = FakeClient(self.samples, num_partitions)
        _, number_of_batches, messages = self._get_scanner_messages(client_mock, simple_consumer_mock,
    ...
    def test_kafka_scan_batchsize_count_partitions(self, client_mock, simple_consumer_mock):
    ...
    def test_kafka_scan_dedupe_batches(self, client_mock, simple_consumer_mock):
        self.test_kafka_scan_dedupe(batchsize=200)

    def test_kafka_scan_deleted(self, client_mock, simple_consumer_mock, batchsize=10000):
        msgs = [('AD%.3d' % i, 'body %d' % i) for i in range(1000)] + \
    ...
    def test_kafka_scan_deleted_batches(self, client_mock, simple_consumer_mock):
        self.test_kafka_scan_deleted(batchsize=200)

    def test_kafka_scan_deleted_before(self, client_mock, simple_consumer_mock, batchsize=10000):
    ...
    def test_kafka_scan_nodelete(self, client_mock, simple_consumer_mock):
        msgs = [('AD%.3d' % i, 'body %d' % i) for i in range(1000)] + \
                [('AD%.3d' % i, None) for i in range(100, 200)]
        samples = get_kafka_msg_samples(msgs)
    ...
    def test_kafka_scan_dedupe_many(self, client_mock, simple_consumer_mock):
    ...
    def test_kafka_scan_lower_offsets(self, client_mock, simple_consumer_mock, batchsize=10000):
        msgs = [('AD%.3d' % i, 'body %d' % i) for i in range(1000)] + \
                [('AD%.3d' % i, None) for i in range(100, 200)]
        samples = get_kafka_msg_samples(msgs)
    ...
    def test_wrong_encoding(self, client_mock, simple_consumer_mock):
        msgs = [('AD001', '>\xc4\xee')]
        samples = get_kafka_msg_samples(msgs)
        client_mock.return_value = FakeClient(samples, 1)
        _, _, messages = self._get_scanner_messages(client_mock, simple_consumer_mock)
